...
import { CheckIcon, StarIcon, BookmarkIcon, CalendarIcon, UploadIcon, DrumIcon as DragIcon, TagIcon } from 'lucide-react'
          ...
          <section id="extension" className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-1/2">
                <img src="/placeholder.svg?height=300&width=400" alt="Chrome Extension Demo" className="rounded-lg shadow-lg" />
              </div>
            </div>
          </section>
