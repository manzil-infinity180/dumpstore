...
![Diagram of ALLOW traffic only to a port of an application policy](https://raw.githubusercontent.com/ahmetb/kubernetes-network-policy-recipes/master/img/9.gif)
